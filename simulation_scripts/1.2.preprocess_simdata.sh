...
## script that takes the simulate map file and multiplies the SNP positions
## to make them integers and not floats
...
echo " - preprocessing simulated data (multiplying marker position by power of 10: 10^5)"
